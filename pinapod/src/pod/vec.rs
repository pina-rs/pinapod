...
impl<'a, T: ZcElem, const N: usize, const PFX: usize> IntoIterator for &'a PodVec<T, N, PFX> {
    type Item = &'a T;
...
impl<'a, T: ZcElem, const N: usize, const PFX: usize> IntoIterator for &'a mut PodVec<T, N, PFX> {
    type Item = &'a mut T;
