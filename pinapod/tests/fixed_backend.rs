#![allow(
    ...
    missing_docs,
    reason = "the derive macro emits audited zero-copy code, upstream layout assertions intentionally spell out trait paths, and these test fixtures are not a published surface"
)]
