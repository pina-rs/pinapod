#![allow(
	unsafe_code,
	missing_docs,
	reason = "the derive macro emits audited zero-copy representation implementations and these \
	          test fixtures are not a published surface"
)]
